...
type HelloServiceClient interface {
	...
	Hello1(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error)
...
func (c *helloServiceClient) Hello1(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/HelloService/Hello1", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) GetUser(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
	err := c.cc.Invoke(ctx, "/HelloService/GetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], "/HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
type HelloServiceServer interface {
	...
	Hello1(context.Context, *String) (*String, error)
...
func (UnimplementedHelloServiceServer) Hello1(context.Context, *String) (*String, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Hello1 not implemented")
}
func (UnimplementedHelloServiceServer) GetUser(context.Context, *GetUserReq) (*User, error) {
...
func _HelloService_Hello1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(String)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloServiceServer).Hello1(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/HelloService/Hello1",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).Hello1(ctx, req.(*String))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _HelloService_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/HelloService/GetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).GetUser(ctx, req.(*GetUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Hello1",
			Handler:    _HelloService_Hello1_Handler,
		},
		{
			MethodName: "GetUser",
